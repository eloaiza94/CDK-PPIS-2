...
# 🔤 Add Google Fonts for cozy vibe
st.markdown("""
...
# 🎨 Apply cozy coffee shop CSS theme
st.markdown("""
<style>
body {
    background-color: #f8f3eb;
    background-image: url('https://images.unsplash.com/photo-1511920170033-f8396924c348?ixlib=rb-4.0.3&auto=format&fit=crop&w=1950&q=80');
...
.stButton > button {
    background: linear-gradient(135deg, #6e4b3a, #a67c52);
    color: #f8f3eb;
    border-radius: 8px;
...
if st.button("Generate Match Report") and estimate_file and cdk_text.strip():
    with st.spinner("Processing your cozy match report..."):
        ...
        st.success("☕ Your cozy match report is ready!")
